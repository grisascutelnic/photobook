    ...
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color:#3097D1">
            ...
            <div class="collapse navbar-collapse" id="responsive">
                <ul class="navbar-nav mr-auto text-capitalize">
                    ...
                    <li class="nav-item"><a href="notification.jsp" class="nav-link">docs</a></li>
                ...
                <a href="notification.jsp" class="text-decoration-none" style="color:#CBE4F2;font-size:22px;"><i class="far fa-bell ml-3 d-none d-md-block"></i></a>
